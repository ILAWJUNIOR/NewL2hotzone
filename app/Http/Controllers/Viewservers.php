...
class Viewservers extends Controller
{
    ...
    public function homepage()
    {
        ...
        $textad_main = DB::table('textads as ads')->where(['status'=>1, 'delete_flag'=>0])->get();
        ...
        foreach ($premiumyourtextservers as $key1 => $value1) {
            ...
            } elseif (isset($textad_sub['premium'][$key1])) {
        ...
        foreach ($newyourtextServer as $key1 => $value1) {
            ...
            } elseif (isset($textad_sub['newest'][$key1])) {
        ...
        foreach ($toptextServer as $key => $value) {
            ...
            } elseif (isset($textad_sub['top'][$key])) {
                $toptext[$key] = $value;
        ...
        foreach ($upcomingtextServer as $key => $value) {
            ...
            } elseif (isset($textad_sub['upcoming'][$key])) {
        ...
        if ($serverDetails) {
            ...
            foreach ($uptime_history as $key => $value) {
                ...
                if ($value->first_section_status == 1 && $value->second_section_status == 1) {
                    $graph_value = 100;
                } elseif ($value->first_section_status == 1 || $value->second_section_status == 1) {
                    $graph_value = 50;
                }
